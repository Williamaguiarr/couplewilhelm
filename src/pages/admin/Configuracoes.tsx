...
const PRESET_COLORS = [
  ...
  { label: "Preto", value: "#0D0D0D" },
  { label: "Grafite", value: "#2D2D2D" },
  { label: "Cinza Azul", value: "#1E2A38" },
  { label: "Vinho", value: "#5C1A1A" },
  { label: "Borgonha", value: "#4A0020" },
  { label: "Petróleo", value: "#0D3B4A" },
  { label: "Teal", value: "#0F3D3D" },
  { label: "Verde Floresta", value: "#1A3D2B" },
  { label: "Musgo", value: "#2E3D2A" },
  { label: "Royal", value: "#1A1F6E" },
  { label: "Índigo", value: "#1E1B4B" },
  { label: "Chocolate", value: "#3E1F00" },
  { label: "Cobre Escuro", value: "#5C3010" },
  { label: "Nude", value: "#4A3728" },
  { label: "Cinza Quente", value: "#3A3530" },
];
...
const PRESET_SECONDARY = [
  ...
  { label: "Prata", value: "#9E9E9E" },
  { label: "Platina", value: "#C0C0C0" },
  { label: "Rosé Gold", value: "#C7748A" },
  { label: "Salmão", value: "#D4826A" },
  { label: "Coral", value: "#C4614A" },
  { label: "Terracota", value: "#B55A3A" },
  { label: "Jade", value: "#3A7D6A" },
  { label: "Esmeralda", value: "#4A8C64" },
  { label: "Teal Claro", value: "#2A8C8C" },
  { label: "Azul Aço", value: "#4A7FA5" },
  { label: "Lavanda", value: "#8A6EC9" },
  { label: "Lilás", value: "#9F7FBA" },
];
